...
const qa = {
  hash: "svelte-beco3k",
  code: `.llm-chat-root.svelte-beco3k {display:flex;flex-direction:column;height:calc(100dvh - 70px);max-height:calc(100dvh - 70px);min-height:300px;overflow:hidden;background:transparent;}
